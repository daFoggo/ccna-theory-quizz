...
declare module "@tanstack/react-table" {
	...
	interface ColumnMeta<TData extends RowData, TValue> {
		...
		// biome-ignore lint/suspicious/noExplicitAny: intentional, value can be any table cell type
...
// biome-ignore lint/suspicious/noExplicitAny: intentional generic default, matches TanStack patterns
export interface IDataTableColumnDef<TData, TValue = any> {
	...
	enableReorder?: boolean;
	/** Custom renderer for grouped row values. */
	// biome-ignore lint/suspicious/noExplicitAny: value can be any table cell type
	renderGroupValue?: (value: any) => React.ReactNode;
