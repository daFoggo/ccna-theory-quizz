...
export const Route = createFileRoute("/dashboard/$experimentId/examples/")({
	staticData: {
...
const demos = [
	{
		to: "/dashboard/$experimentId/examples/crud-table",
		icon: IconTable,
		title: "CRUD table",
		description:
	...
	{
		to: "/dashboard/$experimentId/examples/form",
		icon: IconSchema,
	...
	{
		to: "/dashboard/$experimentId/examples/detail",
		icon: IconBox,
		title: "Detail view",
		description:
	...
	{
		to: "/dashboard/$experimentId/examples/settings",
		icon: IconSettings,
		title: "Settings",
		description:
	...
	{
		to: "/dashboard/$experimentId/examples/inbox",
		icon: IconInbox,
	...
	{
		to: "/dashboard/$experimentId/examples/kanban",
		icon: IconColumns,
		title: "Kanban board",
